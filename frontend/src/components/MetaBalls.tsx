  ...
  useEffect(() => {
    ...
    function update(t: number) {
      ...
      for (let i = 0; i < effectiveBallCount; i++) {
        ...
        const th = p.st + dt;
        const posX = Math.cos(th) * p.baseScale * clumpFactor;
        const posY = Math.sin(th + dt * p.toggle) * p.baseScale * clumpFactor;
    ...
    color, cursorBallColor, speed, enableMouseInteraction,
    hoverSmoothness, animationSize, ballCount, clumpFactor,
    cursorBallSize, enableTransparency,
  ]);
